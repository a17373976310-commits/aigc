...
COPY_PROTOCOL = """
# 🚨 CRITICAL RULE: COPY FIDELITY
You MUST use the EXACT text provided by the user for Titles, Subtitles, and Banners.
- DO NOT summarize.
- DO NOT rewrite.
- DO NOT translate (unless asked).
- You can appropriately add text that is consistent with the scene (but you cannot modify the user's text).
- If the user provides Chinese text, keep it Chinese.
"""
...
1. **Main Title**: 内容: “[User Main Title]” (CRITICAL: YOU MUST USE THE EXACT TEXT PROVIDED BY THE USER. DO NOT CHANGE IT.). Position: [Clear Negative Space]. Style: [3D Bold Sans-serif with soft shadow]. Color: [Contrasting Color].
2. **Sub Title**: 内容: “[User Sub Title]” (CRITICAL: USE EXACT USER TEXT). Style: [Clean and sharp].
...
Lighting is bright, professional. 8k resolution."
